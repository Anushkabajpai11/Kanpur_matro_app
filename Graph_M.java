...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t Kanpur Metro Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{		
			...
			g.addVertex("IIT Kanpur~IITK");
			g.addVertex("Kalyanpur~K");
			g.addVertex("SPM Hospital~S");
			g.addVertex("Vishwavidyalay~V");
			g.addVertex("Gurudev Chauraha~GC");
			g.addVertex("Geeta Nagar~G");
			g.addVertex("Rawatpur~R");
			g.addVertex("LLR Hospital~LH");
			g.addVertex("Moti Jheel~M");
			
			
			g.addEdge("IIT Kanpur~IITK", "Kalyanpur~K", 1);
			g.addEdge("Kalyanpur~K", "SPM Hospital~S", 1);
			g.addEdge("SPM Hospital~S", "Vishwavidyalay~V", 1);
			g.addEdge("Vishwavidyalay~V", "Gurudev Chauraha~GC", 1);
			g.addEdge("Gurudev Chauraha~GC", "Geeta Nagar~G", 1);
			g.addEdge("Geeta Nagar~G", "Rawatpur~R", 1);
			g.addEdge("Rawatpur~R", "LLR Hospital~LH", 1);
			g.addEdge("LLR Hospital~LH", "Moti Jheel~M", 1);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			System.out.println("\n\t\t\t****WELCOME TO THE KANPUR METRO APP*****");
